  ...
  return (
    <main className="shell">
      <section className="hero" aria-labelledby="study-title">
        ...
        <p className="lede">
          Read Scripture cleanly, then move into guided discovery when you are ready.
        </p>
        <div className="study-list">
          <article className="study-card">
            <p className="eyebrow">Bible</p>
            <h2>Read John 1</h2>
            <p>Open the first provider-backed Bible reader checkpoint using the verified Emmaus KJV corpus.</p>
            <Link className="primary-action" href="/study/bible">
              Open Bible
            </Link>
          </article>
          <article className="study-card">
