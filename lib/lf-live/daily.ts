...
export async function ensureDailyRoom(sessionId:string,existingRoom?:string|null){
  ...
  return dailyFetch<{name:string;url:string}>("/rooms",{method:"POST",body:JSON.stringify({name:roomName(sessionId),privacy:"private",properties:{exp,eject_at_room_exp:true,enable_prejoin_ui:false,enable_screenshare:false,enable_chat:false,start_video_off:false,start_audio_off:false}})});
}
