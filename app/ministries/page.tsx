    ...
    <main className="lfp-page pb-24">
      ...
      <div className="lfp-shell py-10 sm:py-14">
        ...
        <section className="mt-12 grid gap-5 lg:grid-cols-[1fr_0.7fr]">
          ...
          <aside className="rounded-[2rem] border border-amber-200 bg-amber-50 p-6 sm:p-8"><p className="text-xs font-black uppercase tracking-[0.16em] text-amber-800">Not sure where to start?</p><h2 className="mt-2 text-2xl font-black text-slate-950">Use Ministry Compass.</h2><p className="mt-3 leading-7 text-slate-600">Answer three simple questions about what you need, how you prefer to engage, and what kind of step feels realistic. Compass will suggest a transparent next step without judging your spiritual maturity.</p><Link href="/compass" className="lfp-button mt-5 bg-slate-950 text-white">Open Ministry Compass →</Link></aside>
        </section>
      </div>
    </main>
  );
