    ...
    <main className="lfp-page pb-20">
      <section className="relative overflow-hidden bg-slate-950 text-white">
        ...
        <div className="lfp-shell relative py-10 sm:py-14">
          ...
          <h1 className="mt-4 max-w-4xl text-4xl font-black tracking-tight sm:text-5xl">Notifications for {firstName}</h1>
          <p className="mt-4 max-w-3xl text-lg leading-8 text-indigo-100/75">Prayer updates, care reminders, approvals, and other actions that need your attention.</p>
        </div>
      </section>
